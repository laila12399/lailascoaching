...
A study of 87 professional performers found that those with higher scores of perfectionism were likely to have lower levers of goal satisfaction and greater performance anxiety[^7].

## :heavy_plus_sign: 'Avantages' of Dimentions of Perfectionsm
...
### :white_square_button: Contrasting Perspective

As this 2019 paper [^8] acknowledges, perfectionistic behaviors should be weighed against their drawbacks, perfectionism, under certain conditions or in combination with certain traits, does not always result in detrimental outcomes.

For one, a paper by Baer & Shaw[^9] asserted, “pursuing perfection is not only an obligation to our community and constituents, it is also an obligation to us. We form ourselves as we work toward perfection. If we tolerate mediocrity, we deny ourselves the opportunity to develop fully”.

### :reminder_ribbon: Confidence in Own Abilities

A branch of research acknowledges that perfectionism is a dynamic characteristic by differentiating between ‘perfectionistic concerns' (e.g. self-criticism or concerns over making mistakes) and 'perfectionistic strivings’ (e.g. setting high standards).


Perfectionistic concerns have been associated with counterproductive patterns, while perfectionistic strivings may form part of a healthy striving for excellence with positive links to self-confidence and goal orientation[^10].


Perfectionistic strivings have been linked to high self-efficacy (belief in own ability) and increased confidence after success while perfectionistic concerns have been linked to low self-efficacy and loss of confidence after failure[^11].
### :triangular_flag_on_post: Goal Setting

In general, there can be a emotional challange to overcome when setting specific goals, as this also specifies conditions for failure.

Therefore overcoming this emotinal hurdle and setting goals for onself can be a sign of valor and strength of mind.

Setting specific goals has been shown to significantly improve productivity[^12], lead to better performances[^13]  and facilitates goal attainment[^14].

Perfectionism has been associated to goal commitment[^15]. Perfectionistic strivings have been linked with higher rates of goal setting[^16].
### :trident: Locos of control

A study of 391 primary school administrators found that hight locos of control (the extent to which they believe they have influence over a situation) can be used to predict perfectionism[^17]. This suggests that high locus of control is linked to the root of perfectionism.
